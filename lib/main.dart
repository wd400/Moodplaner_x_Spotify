...
final authUrl =
    'https://accounts.spotify.com/authorize?client_id=448ecc40021045d99f840f245e1240fe&redirect_uri=$redirectUri&scope=user-read-private%20playlist-read-private%20playlist-modify-private&response_type=token&state=';
...
class _MyHomePageState extends State<MyHomePage> {
  void _login(Uri receivedUri) {
    print(receivedUri);
    context.read(tokenProvider).update(
        value: receivedUri.fragment
            .split('&')
  ...
  Widget build(BuildContext context) {
    Widget generatedPlaylist = Column(children: [
      Flexible(child: Consumer(builder: (BuildContext context,
          ...
          if (constraints.maxWidth > 600) {
            return Row(children: [
              ...
              Flexible(
                  ...
                  flex: 4),
              Flexible(child: generatedPlaylist)
            ]);
          } else {
            return Row(
              children: [
